sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/umicore/ac/test/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.umicore.ac.test.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/umicore/ac/test/localService/mockserver"], function (mockserver) {
